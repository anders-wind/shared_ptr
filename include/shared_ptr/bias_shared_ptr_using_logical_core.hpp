...
struct shared_ptr
{
  ...
  public:
    ...
    [[nodiscard]] auto operator->() const noexcept -> const element_type* { return this->control_block_->data; }

    [[nodiscard]] auto operator->() noexcept -> element_type* { return this->control_block_->data; }
    ...
    void swap(shared_ptr other) { std::swap(this->control_block_, other->control_block_); }
